...
def run_example(furniture_items):
    ...
    def run_json():
        ...
        furniture = [{'product': 'Red couch', 'description': 'Leather low back'},
                     ...
                     {'product': 'Red couch', 'description': 'Corduroy'},
                     {'product': 'Red chair', 'description': 'Wood'},
                     {'product': 'Gray sofa', 'description': 'Leather'},
                     {'product': 'Tan cloth', 'description': 'Silk'},
                     {'product': 'Yellow pillow', 'description': 'Small'},
                     {'product': 'Beige carpet', 'description': 'Boring'},
                     {'product': 'Rainbow wallpaper', 'description': 'Exciting'}]
        ...
        log.info("Step 6: assert read object matches original")
        assert furniture == furniture_object
