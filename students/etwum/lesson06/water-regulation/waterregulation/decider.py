...
class Decider(object):
    ...
    def __init__(self, target_height, margin):
        ...
        :param margin: the margin of liquid above and below the
        target height for
    ...
    def decide(self, current_height, current_action, actions):
        ...
        of liquid in the tank and the current action of the pump.

        Note that the new action for the pump MAY be the same
        as the current action of the pump.
        ...
        The *decide* method shall obey the following behaviors:
          ...
          4. If the pump is performing PUMP_IN and the height is
          above the target height, then the pump shall be turned
          to PUMP_OFF, otherwise the pump shall remain at PUMP_IN.
          5. If the pump is performing PUMP_OUT and the height
          is below the target height, then the pump shall be turned
          to PUMP_OFF, otherwise, the pump shall remain at PUMP_OUT.
