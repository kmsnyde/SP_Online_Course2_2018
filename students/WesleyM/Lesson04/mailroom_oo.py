...
def user_input():
    try:
        ...
        print("\nEnter 1 to 'Send a Thank You', 2 to 'Create a Report',3 to 'Send Letter to Everyone', " +
              "4 to 'Create a Challenge Factor Report', 5 to 'Create Projections', 6 to 'Save to JSON', 7 to 'Load JSON Database', or 8 to 'Quit'\n")
    else:
...
choices = {1: donor_db.send_thankyou, 2: donor_db.create_report, 3: donor_db.send_letters, 4: lambda: donor_db.challenge(factor_input()),
           5: lambda: donor_db.projection(projection_input()), 6: donor_db.save_json, 7: donor_db.open_json, 8: donor_db.close_program}
