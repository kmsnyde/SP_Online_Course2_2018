...
def populate_depts():
    ...
    depts = [
        ('ANLS', 'Analyst', 'Jacob Jacobson'),
        ('ADMN', 'Administration', 'Bob Bobberfield'),
        ('INFT', 'Information Technology', 'Jack Jackson')
        ]
    ...
    try:
        ...
        for dept in Department:
            logger.info(f'{dept.dept_number} : {dept.dept_mgr} manages {dept.dept_name}')
...
def populate_jobs():
    ...
    jobs = [
        ('Analyst', '2001-09-22', '2003-01-30',65500, 'Andrew', 'ANLS'),
        ('Senior analyst', '2003-02-01', '2006-10-22', 70000, 'Andrew', 'ANLS'),
        ('Senior business analyst', '2006-10-23', '2016-12-24', 80000, 'Andrew', 'ANLS'),
